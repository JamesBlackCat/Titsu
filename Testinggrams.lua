...
window.Position = UDim2.new(0, 24, 0.5, -305)
...
addNumber(targetPage, "Target FOV radius", S.aimlockFOVRingSize, 1, 800,
    function(v) S.aimlockFOVRingSize = v; S.aimlockFOV = v end, "pixels")
addNumber(targetPage, "Target range", S.aimlockRange, 1, 10000,
...
addNumber(visualPage, "NPC display distance", S.espDistance, 10, 5000,
...
addToggle(rotationPage, "Player part rotation", S.playerTPEnabled, function(v)
    S.playerTPEnabled = v
end)
addToggle(rotationPage, "NPC part rotation", S.npcTPEnabled, function(v)
    S.npcTPEnabled = v
end)
...
addNumber(rotationPage, "Prediction strength", S.aimlockPredictStrength, 0, 10,
    function(v) S.aimlockPredictStrength = v end, "0 - 10")
...
local hintText = makeLabel(hintCard, "RightControl toggles this panel.  P toggles aimlock.",
...
do
    ...
    UserInputService.InputEnded:Connect(function(input)
        if input == dragInput then dragInput, dragStart, startPosition = nil, nil, nil end
    end)
end
